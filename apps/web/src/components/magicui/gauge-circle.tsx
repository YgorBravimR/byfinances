...
export const GaugeCircle = ({ max = 100, min = 0, value = 0, gaugePrimaryColor, gaugeSecondaryColor, className, displayValue }: Props) => {
  ...
  return (
    ...
    >
      ...
      <span data-current-value={currentPercent} className="duration-[var(--transition-length)]  inset-0 m-auto h-fit w-fit ease-linear animate-in fade-in">
